...
HD_PWD='D:/Project/FPGA/022_block_nonblock/022_block_nonblock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_nonclock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_nonclock.tcl
