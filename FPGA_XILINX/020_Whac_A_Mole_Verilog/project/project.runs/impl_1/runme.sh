...
HD_PWD='D:/Project/FPGA/Whac_A_Mole_Verilog/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_of_whack_a_mole.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_of_whack_a_mole.tcl -notrace
