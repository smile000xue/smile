...
HD_PWD='D:/Project/FPGA/Whac_A_Mole_Verilog/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_of_whack_a_mole.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_of_whack_a_mole.tcl
