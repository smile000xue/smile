...
HD_PWD='D:/Project/FPGA/randomled/randomled.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log randomled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source randomled.tcl -notrace
