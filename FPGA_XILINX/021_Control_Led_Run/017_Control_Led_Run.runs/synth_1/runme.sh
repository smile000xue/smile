...
HD_PWD='D:/Project/FPGA/017_Control_Led_Run/017_Control_Led_Run.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ControlLedrun.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ControlLedrun.tcl
