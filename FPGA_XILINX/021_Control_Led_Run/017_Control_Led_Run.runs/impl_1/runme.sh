...
HD_PWD='D:/Project/FPGA/017_Control_Led_Run/017_Control_Led_Run.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ControlLedrun.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ControlLedrun.tcl -notrace
