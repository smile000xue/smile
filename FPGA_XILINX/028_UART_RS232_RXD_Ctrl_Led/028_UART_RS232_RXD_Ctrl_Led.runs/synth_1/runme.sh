...
HD_PWD='D:/Project/FPGA/028_UART_RS232_RXD_Ctrl_Led/028_UART_RS232_RXD_Ctrl_Led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RXD_Ctrl_Led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_RXD_Ctrl_Led.tcl
