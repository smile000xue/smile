...
HD_PWD='D:/Project/FPGA/randomled/randomled.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log randomled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source randomled.tcl
