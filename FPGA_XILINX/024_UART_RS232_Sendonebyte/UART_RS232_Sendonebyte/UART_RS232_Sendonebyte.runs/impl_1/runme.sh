...
HD_PWD='D:/Project/FPGA/024_UART_RS232_Sendonebyte/UART_RS232_Sendonebyte/UART_RS232_Sendonebyte.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_Sendonebyte.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_Sendonebyte.tcl -notrace
