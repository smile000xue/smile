...
HD_PWD='D:/Project/FPGA/024_UART_RS232_Sendonebyte/UART_RS232_Sendonebyte/UART_RS232_Sendonebyte.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_Sendonebyte.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_Sendonebyte.tcl
