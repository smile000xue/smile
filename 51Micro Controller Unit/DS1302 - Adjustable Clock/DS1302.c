...
unsigned char time[]={23,6,25,16,50,00,7};
...
//	DS1302_Write(WP,0x00);
	...
	DS1302_Write(DATA,time[2]/10*16+time[2]%10);
	DS1302_Write(HOUR,time[3]/10*16+time[3]%10);
	DS1302_Write(MINUTES,time[4]/10*16+time[4]%10);
	DS1302_Write(SECONDS,time[5]/10*16+time[5]%10);
